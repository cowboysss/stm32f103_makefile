...
int main(int argc, char *argv[])
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2; // GPIO No. 12
	...
	while(1)
	{
		GPIOD->BSRR = GPIO_BSRR_BS2; // GPIO PC12 set, pin=high, LED STAT off
		...
		GPIOD->BSRR  = GPIO_BSRR_BR2; // GPIO PC12 reset, pin=low, LED STAT on
